...
class FilmWork(TimeStampedModel):
    ...
    creation_date = models.DateField(
        _('creation_date'), null=True, blank=True, )
    ...
    rating = models.FloatField(_('rating'), validators=[
        MinValueValidator(0.0), MaxValueValidator(10.0)], null=True, blank=True)
...
class GenreFilmWork(models.Model):
    ...
    film_work = models.ForeignKey(
        FilmWork, to_field='id', on_delete=models.CASCADE)
...
class PersonFilmWork(models.Model):
    ...
    role = models.CharField(_('role'), max_length=20,
                            choices=PersonFilmWorkRoles.choices)
    created_at = models.DateTimeField(auto_now_add=True)
